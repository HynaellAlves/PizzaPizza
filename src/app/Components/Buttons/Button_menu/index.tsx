...
export default function Button(props: Types) {
    ...
    const notify = (validation: boolean | undefined | unknown) => {
        ...
        } else if ( !validation|| validation == undefined || validation !== undefined && validation !== true || false) {
    ...
    const add = async () => {
        const response = await add_cart(props.pizzaProps);
